...
public final class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase database, int oldVersion, int newVersion) {
        ...
        if (oldVersion < 4) {
            database.execSQL("ALTER TABLE " + USER_TABLE + " ADD COLUMN " + FIRST_NAME + " TEXT NOT NULL DEFAULT ''");
            database.execSQL("ALTER TABLE " + USER_TABLE + " ADD COLUMN " + LAST_NAME + " TEXT NOT NULL DEFAULT ''");
